...
//	private JMenuItem change, style, theme; // Option Menu Options.
	...
	/*	mnuOpt.add(change);
		...
		// author = new JLabel (" " + "Banking App JAVA MINIPROJECT.", Label.LEFT);
	...
	String makeRecordPrint(int rec) {
		...
		String data;
		String data0 = "               Banking App JAVA MINIPROJECT               \n"; // Page Title.
		...
		String data6 = "          Copyright � 2021 Abhishek Jani.\n"; // Page Footer.
		String sep0 = " -----------------------------------------------------------\n";
		String sep1 = " -----------------------------------------------------------\n";
		String sep2 = " -----------------------------------------------------------\n";
		String sep3 = " -----------------------------------------------------------\n";
